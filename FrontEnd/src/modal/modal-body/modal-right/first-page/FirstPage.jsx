...
export default function FirstPage({pageNum, setPageNum}){
        ...
        <>
            <div className='p1-body-content'>
                ...
                <div className='bottom-content'>
                    <button type="button" class="btn btn-outline-primary continue-btn" onClick={()=>incrementPageNum()}>Commencer la Génération de Rapports</button>
                </div>
            </div>
        </>
    )
